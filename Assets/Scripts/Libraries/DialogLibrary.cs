...
public static class DialogLibrary
{
    ...
    private static void CreateDialogDictionary()
    {
            ...
            dialogOption.AddAction(() =>
                {
                    ...
                    transitionManager.InitiateTransition(0.3f, 0.3f, tranActions, true);
                });
            SetCommonData(id, dialogOption);
            dialogOptionsDict.Add(id, dialogOption);
        }
        ...
        { //enchant armor
            ...
            dialogOption.AddAction(() => ItemManager.AddItemToPosession(null, ItemManager.ProcureItemData(8, 0, 100, 0)));
            dialogOption.AddAction(() =>
            {
...
// ADD HERE
        ...
        { // Death ending
            ...
            DialogOption dialogOption = new DialogOption();
            dialogOption.SetDialogEndFlag(true);
            dialogOption.AddAction(() => cutsceneManager.InitiateCutscene("dieending", 0.5f, 0.5f, 3f));
        ...
        { // Leave ending
            ...
            dialogOption.SetDialogEndFlag(true);
            dialogOption.SetDialogTransition(true);
            dialogOption.AddAction(() => cutsceneManager.InitiateCutscene("leaveending", 0.5f, 0.5f, 3f));
        ...
        { // Join ending
            ...
            dialogOption.SetDialogEndFlag(true);
            dialogOption.SetDialogTransition(true);
            dialogOption.AddAction(() => cutsceneManager.InitiateCutscene("joinending", 0.5f, 0.5f, 3f));
        ...
        { // Kill ending
            ...
            dialogOption.SetDialogEndFlag(true);
            dialogOption.SetDialogTransition(true);
            dialogOption.AddAction(() => cutsceneManager.InitiateCutscene("killending", 0.5f, 0.5f, 3f));
        ...
        { // Reclaim ending
            ...
            dialogOption.SetDialogEndFlag(true);
            dialogOption.SetDialogTransition(true);
            dialogOption.AddAction(() => cutsceneManager.InitiateCutscene("victoryending", 0.5f, 0.5f, 3f));
        ...
        { // Secret ending
            ...
            dialogOption.SetDialogEndFlag(true);
            dialogOption.SetDialogTransition(true);
            dialogOption.AddAction(() => cutsceneManager.InitiateCutscene("perfectending", 0.5f, 0.5f, 3f));
